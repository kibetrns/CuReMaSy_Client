import "../../styles/quarterly-reports-sub-page.css";
...
const QuarterlyReportsSubPage = () => {
    ...
    datasets: [
      {
        ...
        data: [181, 261, 137, 162],
      },
      {
        label: "Approved",
        backgroundColor: "#848E0F",
        data: [185, 563, 147, 181],
      },
    ],
  };
  ...
  return (
    <div className="Monthly-reports-sub-page-main">
      ...
      >
        <Bar options={options} data={dataQuarterly} />
      </div>
    </div>
  );
};

export default QuarterlyReportsSubPage;
